...
const LoginPage = () => {
  ...
  return (
    <div className='flex justify-center items-center w-screen h-screen bg-primary/50'>
      <div className='flex flex-col text-black items-center bg-white w-[400px] p-8 rounded-2xl'>
